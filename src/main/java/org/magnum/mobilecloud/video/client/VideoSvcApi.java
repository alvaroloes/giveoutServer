...
public interface VideoSvcApi {
	...
	@GET(VIDEO_SVC_PATH)
	public Collection<Gift> getVideoList();
	
	@GET(VIDEO_SVC_PATH + "/{id}")
	public Gift getVideoById(@Path("id") long id);
	
	@POST(VIDEO_SVC_PATH)
	public Gift addVideo(@Body Gift v);
	...
	public Collection<Gift> findByDurationLessThan(@Query(DURATION_PARAMETER) long duration);
